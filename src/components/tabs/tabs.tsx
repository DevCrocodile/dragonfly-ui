...
//     const currentContent = useMemo(() => tabs.find(tab => tab.key === activeTab)?.content ?? null, [activeTab, tabs]);
...
//     return (
//         <>
//             <div className="df:flex df:items-center df:justify-center df:rounded-md df:bg-slate-100 df:p-1 df:gap-1 df:w-fit">
//                 {
//                     tabs.map(tab => (
//                         <Button
//                             variant="ghost"
...
//                             className={cn(activeTab === tab.key ? 'df:border-border df:font-semibold df:bg-white df:hover:bg-white/90' : 'df:border-transparent df:text-muted-foreground df:hover:bg-slate-200', 'df:px-3 df:py-1.5')}
//                         >
//                             {tab.label}
//                         </Button>
//                     ))
